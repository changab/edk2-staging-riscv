  ...
  )
{
  ...
  DEBUG ((DEBUG_INFO, "Calling RISC-V OpenSBi PPI: OpenSbiLibraryScratchThisHartPtr\n"));
  ...
  DEBUG ((DEBUG_INFO, "          Base address of stack:               0x%x\n", BaseOfStack));
  DEBUG ((DEBUG_INFO, "          Top address of stack:                0x%x\n", TopOfStack));
  ...
  DEBUG ((DEBUG_INFO, "Calling RISC-V OpenSBi PPI: OpenSbiLibrarySbiInit\n"));
  SbiLib->OpenSbiLibrarySbiInit (
            PeiServices,
            SbiLib,
            ThisScratch
            );
